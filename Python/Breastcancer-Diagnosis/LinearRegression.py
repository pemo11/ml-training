...
# Description: Linear Regression model for Breast Cancer Diagnosis
...
# Predict
train_predictions = linRegression.predict(X_train)
test_predictions = linRegression.predict(X_test)

# Confusion Matrix
from sklearn.metrics import confusion_matrix
# Geht dieses Mal nicht: Classification metrics can't handle a mix of binary and continuous targets
